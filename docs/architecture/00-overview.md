...
|---|---|---|
| `src/domain/` | kosakata, kurikulum, XP & level, streak, penguasaan kata, bintang, medali, misi, achievement, pembuat soal, perkenalan materi, penggabungan profil, kode sinkron, pelafalan Bahasa Indonesia, cerita & tujuan akhir | aturan permainan & materi belajar |
